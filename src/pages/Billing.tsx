    ...
    <div className="p-6 md:p-8 max-w-5xl mx-auto">
      ...
      <div className="grid lg:grid-cols-3 gap-4 mb-6">
        <div className="lg:col-span-2 rounded-xl border border-border bg-card p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="mt-1 font-display text-2xl font-semibold">Team</div>
            </div>
            <Badge className="bg-success/10 text-success border-success/20 hover:bg-success/10">Active</Badge>
          </div>
          <div className="mt-5 grid sm:grid-cols-3 gap-3">
            <Stat label="Seats" value="12" />
            <Stat label="Analyses (mo)" value="184 / ∞" />
            <Stat label="Next invoice" value="Jul 27, 2026" />
          </div>
          <div className="mt-6 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
            {["Unlimited analyses","All agents","Compare mode","RBAC","Priority support"].map((f) => (
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          ...
          <div className="mt-3 rounded-md border border-border p-3 flex items-center gap-3">
            ...
            <div className="ml-auto text-xs text-muted-foreground">12/27</div>
          </div>
      ...
      <div className="rounded-xl border border-border bg-card overflow-hidden">
        ...
        <div className="divide-y divide-border">
          {[
            { d: "Jun 27, 2026", a: "$588.00", n: "INV-1042" },
            { d: "May 27, 2026", a: "$588.00", n: "INV-1018" },
            { d: "Apr 27, 2026", a: "$539.00", n: "INV-0996" },
          ].map((i) => (
